...
#设置argo-token
TOK=${TOK:-'eyJhIjoiMzg2OGEzNjc2ZTkyZmUxMmY0NjM1YTU0ZmNhMDQ0NDMiLCJ0IjoiMTM0NWE3ZjEtMTVjZi00MjJiLTkxMGEtODk3ZmU2NTA5ZDY1IiwicyI6IlkyWmtOREZpWVRZdFptVXhNeTAwWlRsakxUaGxNRGd0WVdJNVpEUTRZbUV6TjJZMSJ9'}

#设置哪吒
NEZHA_SERVER=${NEZHA_SERVER:-'data.seaw.gq'}
NEZHA_KEY=${NEZHA_KEY:-'jHLQ0g4wu0VvJlOadM'}
